        ...
        <div className="grid grid-cols-1 md:grid-cols-4 gap-8">
          ...
          <div>
            ...
            <div className="flex space-x-4">
              <svg
                className="h-5 w-5 text-gray-400 hover:text-emerald-400 cursor-pointer transition-colors"
                fill="currentColor"
                viewBox="0 0 24 24"
              >
          ...
          <div>
            ...
            <div className="flex">
              <input
                ...
                className="flex-1 px-3 py-2 bg-gray-800 border border-gray-700 rounded-l-md focus:outline-none focus:border-emerald-400"
              />
              <button className="px-4 py-2 bg-emerald-600 hover:bg-emerald-700 rounded-r-md transition-colors">
                Suscribir
              </button>
            </div>
          </div>
